...
TEXT_SECURE_WEBSOCKET_API = os.environ.get("TEXT_SECURE_WEBSOCKET_API", "wss://chat.signal.org/v1/websocket/")

TEXT_SECURE_SERVER_URL = os.environ.get("TEXT_SECURE_SERVER_URL", "https://textsecure-service.whispersystems.org/")
